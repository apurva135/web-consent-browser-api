class GDPRConfig {
  ...
  static setConsentReceipt(entries) {
    return new Promise((resolve, reject) => {
      chrome.storage.local.set(
        {
          consentReceipt: entries,
        },
        () => {
          resolve();
        }
  ...
  static getConsentValues() {
    return new Promise((resolve, reject) => {
      chrome.storage.sync.get(
        ...
        (result) => {
          resolve(
            Object.assign({}, GDPRConfig.defaultValues, result.consentValues)
          );
        }
      );
    });
  ...
  static getDebugValues() {
    return new Promise((resolve, reject) => {
      chrome.storage.sync.get(
        ...
        (result) => {
          resolve(
            Object.assign({}, GDPRConfig.defaultDebugFlags, result.debugFlags)
          );
        }
      );
    });
  ...
  static removeRuleList(list) {
    return new Promise((resolve, reject) => {
      GDPRConfig.getRuleLists().then((ruleLists) => {
        GDPRConfig.setRuleLists(
          ruleLists.filter((ruleList) => {
  ...
  static async getDebugFlags() {
    ...
    return [
      ...
      },
      {
        name: "scrapingMode",
        description:
          "Put small stats attribute with JSON string on html element, for scraping testing",
