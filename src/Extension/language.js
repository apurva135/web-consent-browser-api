const translations = {
    ...
    "CHOICE_DESCRIPTION": {
        "en": "Configure which types of tracking you want to allow. Consent Manager will then automatically handle consent pop-ups according to your preferences. By default, all tracking except essential is rejected.",
        "da": "Konfigurer hvilke tracking-kategorier du gerne vil tillade. Så vil Consent Manager udfylde samtykke-popups så godt den kan baseret på dine valg. Som standard bliver alt tracking afvist.",
        "de": "Legen Sie fest, welche Kategorien von Tracking Sie zulassen möchten. Consent Manager füllt dann, basierend auf Ihren Voreinstellungen, die Zustimmungs-Popups so gut wie möglich aus. Standardmäßig wird jegliches Tracking abgelehnt.",
        "pt": "Configure quais categorias de rastreamento você gostaria de permitir. O Consent Manager preenche os pop-ups de consentimento da melhor forma possível com base em suas preferências. Todos os rastreamentos são rejeitados por padrão."
    },
    "RULES_DESCRIPTION": {
        "en": "Consent Manager comes with a set of rules that tell it how to understand each kind of GDPR consent popup. You can add more sources of rules here - or even create your own list and share it with others!",
        "da": "Sammen med Consent Manager følger et sæt af regler der beskriver hvordan hver enkelt slags GDPR-samtykke-popup skal behandles. Du kan tilføje flere regel-kilder her - eller oprette din egen liste og dele den med andre!",
        "de": "Consent Manager wird mit einer Reihe von Regeln geliefert, die ihm sagen, wie es jede Art von GDPR-Einwilligungs-Popup verstehen soll. Sie können hier weitere Quellen für Regeln hinzufügen - oder sogar Ihre eigene Liste erstellen und sie mit anderen teilen!",
        "pt": "O Consent Manager vem com um conjunto de regras de como entender cada tipo de pop-up de consentimento do GDPR. Você pode adicionar mais regras aqui - ou até mesmo criar sua própria lista e compartilhá-la com outras pessoas!"
    },
    "ADD_LIST": {
        "en": "Add List",
        "da": "Tilføj liste",
    ...
    "ABOUT_DESCRIPTION": {
        "en": "Here you can see how many times a popup has been filled out and just how many clicks Consent Manager has saved you.",
        "da": "Her kan du se hvor mange gange der er blevet udfyldt en popup for dig, og hvor mange klik Consent Manager har sparet dig.",
        "de": "Hier können Sie sehen wie häufig ein Popup ausgefüllt wurde und wie viele Klicks dank des Consent Manager gespart wurden.",
        "pt": "Aqui você pode ver quantas vezes um pop-up foi preenchido e quantos cliques o Consent Manager economizou para você."
    },
    "CLICKS_SAVED": {
        "en": "clicks saved",
        "da": "klik sparet",
    ...
    "PREFERENCES_DESCRIPTION": {
        "en": "Allow sites to remember your preferences, like your username, language, or location, and offer enhanced, personalized features. For example, these cookies can save your login details, text size, font choices, and other customizable parts of web pages. They can also enable services you request, such as watching videos or commenting on blogs. These cookies do not track your activity on other websites.",
    ...
    "PERFORMANCE_DESCRIPTION": {
        "en": "Collecting information and combining it with previous data helps websites measure and understand how you use their services. This allows them to count visits and traffic sources, improving site performance. It helps them identify the most and least popular pages, see how visitors navigate the site, and understand where visitors come from.",
    ...
    "CONTENT_DESCRIPTION": {
        "en": "Collecting information and combining it with previous data helps choose and deliver content for you, and measure its effectiveness. This includes using data about your interests to select content, tracking details like what content was shown, how often, for how long, when, and where it was shown, and if you interacted with it (e.g., clicking on it). This data personalizes content not only on the website but also on other websites, apps, browsers, and devices.",
    ...
    "OTHER_DESCRIPTION": {
        "en": "Collecting data for purposes that are not clearly explained by the website or do not fit into any other category.",
    ...
    "OPTIONS_TITLE": {
        "en": "Consent Manager Options",
        "da": "Consent Manager indstillinger",
        "de": "Consent Manager Einstellungen",
        "pt": "Opções do Consent Manager"
    },
    "ARE_YOU_SURE": {
        "en": "Are you sure?",
        "da": "Er du sikker?",
